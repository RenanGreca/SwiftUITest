...
class DetailsViewController: UITableViewController {
    ...
    @IBOutlet weak var repsCell: UITableViewCell!
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.workCell.detailTextLabel?.text = "\(self.details![Strings.kHistoryTotalWorkKey.rawValue]!) minutes"
        
        self.breakCell.detailTextLabel?.text = "\(self.details![Strings.kHistoryTotalBreakKey.rawValue]!) minutes"
